...
export interface Contact { id: string; name: string; role: string; email?: string; last?: string; }
export interface Attachment { id: string; name: string; kind: "resume" | "cover" | "portfolio" | "other"; size: string; }
export interface HistoryEntry { id: string; time: string; title: string; detail: string; kind: "status" | "message" | "note" | "interview" | "task"; }
export interface InterviewRound { id: string; name: string; when: string; interviewer?: string; status: "scheduled" | "done" | "upcoming" | "canceled"; notes?: string; }
export interface AssessmentTask { id: string; label: string; due: string; status: "pending" | "submitted" | "graded"; }
...
export interface FollowUp {
  id: string; company: string; role: string; due: string; kind: "email" | "call" | "message" | "task";
  status: "pending" | "completed"; note: string;
}

export interface CalendarEvent {
  id: string; day: number; month: number; year: number; hour?: number; title: string; company: string;
  kind: "interview" | "deadline" | "followup" | "assessment";
}

export interface QuestionBankItem { id: string; question: string; tag: "behavioral" | "system" | "product" | "coding" | "culture"; }
...
export const applications: Application[] = [
  {
    ...
    recruiter: { id: "c-nw-1", name: "Priya Menon", role: "Talent Partner", email: "priya@northwind.co", last: "2h ago" },
    contacts: [
    ...
    notes: "Panel loves the PromptDeck story. Prep a 5-min system-design walkthrough + retention framework.",
    attachments: [
      { id: "at-1", name: "resume-northwind-v3.pdf", kind: "resume", size: "182 KB" },
      { id: "at-2", name: "cover-letter.pdf", kind: "cover", size: "94 KB" },
    ],
    history: [
      { id: "h-1", time: "2h ago", title: "Onsite scheduled", detail: "Wed 10:00 AM · 4-round panel", kind: "interview" },
      { id: "h-2", time: "Yesterday", title: "Recruiter screen", detail: "45 min with Priya. Positive.", kind: "interview" },
      { id: "h-3", time: "3 days ago", title: "Applied", detail: "Submitted tailored resume v3.", kind: "status" },
    ],
    interviews: [
      { id: "iv-1", name: "Recruiter screen", when: "Yesterday · 3:00 PM", interviewer: "Priya Menon", status: "done", notes: "Went well. Next: onsite." },
      { id: "iv-2", name: "Hiring manager", when: "Wed · 10:00 AM", interviewer: "Dan Ortega", status: "scheduled" },
  ...
  },
  {
    ...
    history: [
      { id: "h-4", time: "1d ago", title: "Assessment sent", detail: "Take-home due Friday.", kind: "task" },
      { id: "h-5", time: "3d ago", title: "Recruiter reply", detail: "Fast-tracked to assessment.", kind: "message" },
      { id: "h-6", time: "1w ago", title: "Applied", detail: "Referral via Marcus.", kind: "status" },
    ],
    interviews: [],
    assessments: [{ id: "as-1", label: "Metering system design", due: "Fri 5:00 PM", status: "pending" }],
  ...
  },
  {
    ...
    history: [
      { id: "h-7", time: "3h ago", title: "Applied", detail: "Tailored resume v3 · cover letter attached.", kind: "status" },
    ],
    interviews: [],
    assessments: [],
  ...
  },
  {
    ...
    history: [
      { id: "h-8", time: "6h ago", title: "Offer extended", detail: "Verbal offer. Written by Friday.", kind: "status" },
      { id: "h-9", time: "1w ago", title: "Final round", detail: "5 interviews. Strong signal.", kind: "interview" },
    ],
    interviews: [
      { id: "iv-5", name: "Final round", when: "1 week ago", status: "done", notes: "Strong signal from all interviewers." },
    ],
    assessments: [],
  ...
  },
  {
    ...
    attachments: [],
    history: [{ id: "h-10", time: "Today", title: "Saved", detail: "Added from Jobs workspace.", kind: "status" }],
    interviews: [],
    assessments: [],
  ...
  },
  {
    ...
    attachments: [],
    history: [
      { id: "h-12", time: "1w ago", title: "Rejected", detail: "Seniority mismatch — try Sr PM roles.", kind: "status" },
      { id: "h-13", time: "3w ago", title: "Recruiter screen", detail: "30 min.", kind: "interview" },
    ],
    interviews: [],
    assessments: [],
    progress: 20,
  },
  {
    ...
    history: [{ id: "h-14", time: "1d ago", title: "Applied", detail: "Tailored resume.", kind: "status" }],
    interviews: [],
    assessments: [],
    glassdoor: 4.0,
    progress: 20,
  },
  {
    ...
    attachments: [],
    history: [
      { id: "h-15", time: "2d ago", title: "Assessment sent", detail: "Due Saturday.", kind: "task" },
      { id: "h-16", time: "5d ago", title: "Applied", detail: "Direct via careers page.", kind: "status" },
    ],
    interviews: [],
  ...
  },
  {
    ...
    attachments: [],
    history: [
      { id: "h-17", time: "4h ago", title: "Technical scheduled", detail: "Thu 4:00 PM.", kind: "interview" },
      { id: "h-18", time: "2d ago", title: "Recruiter screen", detail: "Strong.", kind: "interview" },
    ],
    interviews: [
  ...
  },
  {
    ...
    attachments: [],
    history: [{ id: "h-19", time: "1w ago", title: "Accepted", detail: "Consulting contract.", kind: "status" }],
    interviews: [],
    assessments: [],
    progress: 100,
  },
  {
    ...
    attachments: [],
    history: [{ id: "h-20", time: "3w ago", title: "Archived", detail: "Location constraint.", kind: "status" }],
    interviews: [],
    assessments: [],
    progress: 10,
  },
...
export const followUps: FollowUp[] = [
  { id: "fu-1", company: "Notion", role: "Product Lead, Growth", due: "Today", kind: "email", status: "pending", note: "Recruiter went quiet after Monday." },
  { id: "fu-2", company: "Datadog", role: "Sr PM, Observability", due: "Fri", kind: "message", status: "pending", note: "Thank-you note after recruiter screen." },
  { id: "fu-3", company: "Stripe", role: "Senior PM, Billing", due: "Sat", kind: "task", status: "pending", note: "Submit take-home." },
  { id: "fu-4", company: "Northwind Labs", role: "Sr PM, AI Platform", due: "Yesterday", kind: "email", status: "completed", note: "Thanked Priya post-screen." },
];

export const calendarEvents: CalendarEvent[] = [
  { id: "ev-1", day: 8, month: 6, year: 2026, hour: 15, title: "Follow up · Notion", company: "Notion", kind: "followup" },
  { id: "ev-2", day: 10, month: 6, year: 2026, hour: 10, title: "Northwind onsite panel", company: "Northwind", kind: "interview" },
  { id: "ev-3", day: 11, month: 6, year: 2026, hour: 16, title: "Anthropic technical", company: "Anthropic", kind: "interview" },
  { id: "ev-4", day: 12, month: 6, year: 2026, hour: 17, title: "Stripe take-home due", company: "Stripe", kind: "deadline" },
  { id: "ev-5", day: 13, month: 6, year: 2026, title: "OpenAI product exercise", company: "OpenAI", kind: "assessment" },
  { id: "ev-6", day: 15, month: 6, year: 2026, title: "Respond to Linear offer", company: "Linear", kind: "deadline" },
];
...
export const questionBank: QuestionBankItem[] = [
  ...
  { id: "qb-3", question: "How would you prioritize the next 3 features for Assistants API?", tag: "product" },
  { id: "qb-4", question: "Tell me about a time you disagreed with a senior stakeholder.", tag: "behavioral" },
...
export const aiTips = [
  { id: "tip-1", kind: "prep", title: "Interview prep · Northwind", detail: "Panel is heavy on evaluation frameworks. Lead with PromptDeck." },
  { id: "tip-2", kind: "resume", title: "Tighten resume for Stripe", detail: "Add usage-based pricing keyword to Skills." },
  { id: "tip-3", kind: "research", title: "Company research · Anthropic", detail: "Latest safety paper released Monday — mention it." },
  { id: "tip-4", kind: "negotiation", title: "Negotiation · Linear", detail: "Base is competitive. Push equity refresh at year 2." },
  { id: "tip-5", kind: "followup", title: "Follow-up · Notion", detail: "3 days silent — send a value-add nudge today." },
];
...
export const sidebarFilters = [
  { id: "all", label: "All applications", stages: ["applied","assessment","interview","offer","accepted","rejected"] as Stage[] },
